...
![Install the Visual C++ Build Tools](VisualStudioInstallCPPBuildTools.png#center)
...
![Download the necessary Zip files from Github](GithubDownloadZipArchiveOpenCV.png#center)
...
![OpenCV Build Folder Structure](OpenCVBuildFolderStructure.png#center)
...
![The initial CMake GUI](CMakeInitialGUIViewWindows.png#center)
...
![Initial CMake configuration](OpenCVInitialCMakeConfiguration.png#center)
...
![Generator selector](CMakeGeneratorSelection.png#center)
...
![OpenCV contrib path](CMakeOpenCVContribPath.png#center)
...
![Locate the solution file](OpenCVSolutionFile.png#center)
...
![Select Debug in Visual Studio](SelectDebugVisualStudioOpenCV.png#center)
...
![Build install entry](BuildINSTALLEntry.png#center)
...
![The final build directory](FinalBuildDirectory.png#center)
...
![The final library directory](FinalLibraryDirectory.png#center)
