...
![Search for the edit environment variables application](EditEnvironmentVariablesStartMenu.png#center)
...
![Add environment variable](AddEnvironmentVariable.png#center)
...
![Create the Visual Studio Project](CreateProjectInVisualStudio.png#center)

Once you create the project you’ll be greeted with a standard, boilerplate console app. 

![Console app boiler plate](BoilerPlateConsoleApp.png#center)
...
![Edit solution properties](EditSolutionProperties.png#center)
...
![Edit all configurations](EditAllConfigurations.png#center)
...
![Edit include directories](EditIncludeDirectories.png#center)
...
![Add include directory](AddIncludeDirectory.png#center)
...
![Add library path](AddLibraryPath.png#center)
...
![Change configuration](ChangeConfiguration.png#center)
...
![Additional dependencies](AddAllDebugLibraries.png#center)
...
![Working example](WorkingExample.png#center)
