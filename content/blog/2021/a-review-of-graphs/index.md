...
![What?!](what_breaking_bad.gif#center)
...
![An example graph](ExampleGraph.png#center)
...
![Example of a directed graph](ExampleDirectedGraph.png#center)
...
![Example of the degree of a node in a graph](CompleteGraphExample.png#center)
...
![Example of a loop in a graph](GraphLoopExample.png#center)

## Simple Graphs

A **simple graph** is simply a graph that has no loops and no parallel edges. Let’s look at an example:

![Example of a simple graph](SimpleGraphExample.png#center)
...
![Example of a connected graph](ConnectedGraphExample.png#center)
...
![Example of a graph that is not connected](NonConnectedGraphExample.png#center)
...
![Example of a complete graph](CompleteGraph.png#center)
...
![Adjacency example](AdjacencyExample.png#center)
...
![Example adjacency matrix](AdjacencyMatrix.png#center)
...
![Adjacency example with a directed graph](DirectedGraphAdjacencyExample.png#center)
...
![Adjacency matrix for a directed graph](DirectedAdjacencyMatrix.png#center)
...
![Example of loops in an adjacency matrix](AdjacencyMatrixLoops.png#center)
...
![Adjacency list example graph](AdjacencyListExampleGraph.png#center)

The adjacency list for this graph will look something like this:

![An adjacency list for an undirected graph](AdjacencyListForUndirectedGraph.png#center)
...
![Directed graph adjacency list example](DirectedGraphAdjacencyExampled.png#center)

![An adjacency list for a directed graph](DirectedGraphAdjacencyList.png#center)
