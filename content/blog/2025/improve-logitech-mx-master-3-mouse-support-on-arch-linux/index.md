...
Previously I had [written about how I improved my Logitech peripheral support on PopOS using `solaar` and `libratbag`]({{<ref "/blog/2024/improving-logitech-peripheral-support-on-linux" >}}). This method worked just fine when I was running Pop, but I've recently switched to an Arch Linux setup on my main desktop. Unfortunately, this previous method wasn't working for getting my Logitech MX Master 3 mouse fully working.
