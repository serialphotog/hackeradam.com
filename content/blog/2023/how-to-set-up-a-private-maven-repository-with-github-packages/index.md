...
![Successful GitHub Actions run](GitHubActionsRun.png#center)
...
![GitHub Account Settings](GitHubAccountSettings.png#center)
...
![GitHub Create new Classic Access Token](GitHubClassicToken.png#center)

Give your token whatever name you'd like and give it the `read:packages` permission:

![GitHub Classic Access Token Setup](GitHubTokenCreation.png#center)
...
![GitHub Access Token Page](GitHubAccessToken.png#center)
